            ...
            if(cursor != null){
                if(cursor.moveToFirst()){
                    do{
                        ...
                        td.setId(cursor.getInt(cursor.getColumnIndex(COL_1)));
                        td.setTask(cursor.getString(cursor.getColumnIndex(COL_2)));
                        td.setStatus(cursor.getInt(cursor.getColumnIndex(COL_3)));
                        modelList.add(td);
